...
import com.hensley.ufc.pojo.dto.fighter.FighterXrefBetHistGetDto;

public class BoutBetHistGetDto {
	...
	private Collection<FighterXrefBetHistGetDto> fighterBoutXRefs;
	private String mmaDecBoutUrl;
	private GenderEnum gender;

	public BoutBetHistGetDto() {
	 ...
	 */
	public Collection<FighterXrefBetHistGetDto> getFighterBoutXRefs() {
		return fighterBoutXRefs;
	}

	public void addFighterBoutXRef(FighterXrefBetHistGetDto fighterBoutXRef) {
		if (fighterBoutXRef.getBetMade() != null) {
	 ...
	 */
	public void setFighterBoutXRefs(Collection<FighterXrefBetHistGetDto> fighterBoutXRefs) {
		if (!CollectionUtils.isEmpty(fighterBoutXRefs)) {
			for (FighterXrefBetHistGetDto fighterBoutXRef : fighterBoutXRefs) {
				addFighterBoutXRef(fighterBoutXRef);
			}
		}
	}
