...
public class StrikeBasicDto implements Comparable<StrikeBasicDto> {
...
//	}
	...
	@Override
	public int compareTo(StrikeBasicDto u) {
		if (getRound() == null) {
			return 0;
		}
		return getRound().compareTo(u.getRound());
	}
}
